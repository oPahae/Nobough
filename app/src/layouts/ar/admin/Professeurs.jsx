...
export default function Profs({ setActiveTab }) {
    ...
    return (
        <>
            <Head>
                <title>الأساتذة - أكاديمية نبوغ</title>
                <link rel="icon" href="/logo2-nobg.png" />
            </Head>

            <div className="w-full relative md:px-22" dir="rtl">
                ...
                <div className="mb-12 text-center pt-8 relative">
                    <div className="inline-block">
                        ...
                        <h1 className="text-3xl font-bold text-gray-800">قائمة الأساتذة</h1>
                    ...
                    <p className="text-gray-600 mt-4 max-w-xl mx-auto">إدارة ومتابعة الفريق التعليمي</p>
                </div>

                <div className="flex justify-start px-6 py-4 max-w-6xl mx-auto gap-6">
                    <button
                        onClick={() => setActiveTab('ajouterProf')}
                        className="px-6 py-3 bg-gradient-to-l from-amber-600 to-amber-800 text-white rounded-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5 flex items-center justify-center cursor-pointer"
                    >
                        ...
                        <div key={professeur.id} className="bg-white rounded-xl shadow-xl overflow-hidden transform transition-all hover:-translate-y-1 hover:shadow-2xl relative">
                            <div className="flex flex-col md:flex-row-reverse">
                                ...
                                <div className="p-6 md:w-3/4 relative">
                                    ...
                                    <div className='bg-blue-400 rounded-xl px-2 py-1 w-fit text-white mb-6'>الراتب: {professeur.salaire} درهم</div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                        <div className="flex items-center text-gray-700 bg-amber-50 px-3 py-2 rounded-lg">
                                            ...
                                            <span className="text-sm">ولد في {new Date(professeur.birth).toLocaleDateString('FR-fr')}</span>
                                        </div>
                                        <div className="flex items-center text-gray-700 bg-amber-50 px-3 py-2 rounded-lg">
                                        ...
                                        <div className="flex items-center text-gray-700 bg-amber-50 px-3 py-2 rounded-lg">
                                            ...
                                            <span className="text-sm">بطاقة الهوية الوطنية: {professeur.cin}</span>
                                        </div>
                                    </div>

                                    <div className="mt-4">
                                        <div className="flex items-start text-gray-700">
                                            <BookOpen className="w-5 h-5 text-amber-700 ml-2 mt-1" />
                                            <div>
