...
export default function ModifierAnnonce({ setActiveTab, setNotification }) {
    ...
    const fetchAnnonce = async () => {
        ...
        try {
            ...
            console.error('خطأ أثناء استرجاع الإعلان:', error);
            setLoading(false);
        }
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const data = await response.json();
                setErrors({ general: data.message || 'خطأ أثناء تعديل الإعلان' });
            }
        } catch (error) {
        ...
        <div className="max-w-full relative" dir="rtl">
            ...
            <div className="mb-12 text-center pt-8 relative">
                <div className="inline-block">
                    ...
                    <h1 className="text-3xl font-bold text-gray-800">تعديل إعلان</h1>
                ...
                <p className="text-gray-600 mt-4 max-w-xl mx-auto">قم بتعديل معلومات هذا الإعلان</p>
            </div>
                ...
                {submitted ? (
                    <div className="bg-white/90 backdrop-blur-sm p-8 rounded-xl shadow-xl mb-10 border border-amber-100">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <h2 className="text-2xl font-bold text-gray-800 mb-4">تم تعديل الإعلان بنجاح!</h2>
                            <p className="text-gray-600 mb-8">تم حفظ تعديلاتك.</p>
                            <button
                            ...
                            <div className="mb-6">
                                ...
                                <div className="relative">
                                    ...
                                    <textarea
                                        name="descr"
                                        rows="4"
                                        className={`block w-full pr-12 pl-4 py-4 border ${errors.descr ? 'border-red-300 bg-red-50' : 'border-amber-200'} rounded-xl bg-white/80 shadow-sm focus:outline-none focus:ring-2 focus:ring-amber-600 focus:border-transparent text-gray-700`}
                        ...
                        <div className="bg-amber-50 p-4 rounded-lg mb-8 flex">
                            ...
                            <div>
                                <p className="text-sm text-gray-700">
                                    بتعديل هذا الإعلان، أنت ملتزم باحترام قواعد التواصل في الأكاديمية.
                                </p>
                            </div>
                        </div>
