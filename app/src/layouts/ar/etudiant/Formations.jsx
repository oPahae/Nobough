...
import { categoriesAr } from '@/utils/Constants'
        ...
        <div className="max-w-full relative" dir="rtl">
            ...
            <div className="mb-12 text-center pt-8 relative">
                <div className="inline-block">
                    ...
                    <h1 className="text-3xl font-bold text-gray-800">فهرس التكوينات</h1>
                ...
                <p className="text-gray-600 mt-4 max-w-xl mx-auto">اغتنم مسارك الروحي والشخصي مع تكويناتنا الحصرية</p>
            </div>
            ...
            <div className="mb-8 relative max-w-2xl mx-auto">
                ...
                <input
                    ...
                    placeholder="بحث عن تكوين حسب الاسم، الوصف أو العلامات..."
                    value={searchQuery}
                ...
                <div className="absolute left-3 top-3 flex space-x-2">
                    ...
                    <div className="flex bg-amber-100 rounded-lg shadow-sm">
                        <button
                            ...
                            className={`p-2 rounded-r-lg flex items-center ${activeTab2 === 'grille' ? 'bg-amber-700 text-white' : 'text-amber-800 hover:bg-amber-200'} transition-all`}
                        >
                            <Grid className="w-4 h-4" />
                        </button>
                        <button
                            onClick={() => setActiveTab2('liste')}
                            className={`p-2 rounded-l-lg flex items-center ${activeTab2 === 'liste' ? 'bg-amber-700 text-white' : 'text-amber-800 hover:bg-amber-200'} transition-all`}
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                >
                                    <option value="tous">كل الفئات</option>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                >
                                    <option value="tous">كل المعلمين</option>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <option value="préados">مراهقون</option>
            ...
            {session &&
                <div className="max-w-5xl mx-auto mb-10">
                    <div className="flex justify-center border-t border-amber-200">
                        <button
                            onClick={() => setActiveTab2('grille')}
                        ...
                        >
                            ...
                            {(activeTab2 === 'grille' || activeTab2 === 'liste') && (
                                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-l from-amber-500 to-amber-700"></div>
                            )}
                        </button>
                        <button
                            ...
                            <div className="p-6 relative">
                                ...
                                <div className="flex justify-between items-center mb-4">
                                    <div className="flex items-center bg-amber-50 px-2 py-1 rounded-md">
                                        {formation.duree &&
                                            <>
                                                <Clock className="w-4 h-4 text-amber-700 ml-1" />
                                                <span className="text-sm">{formation.duree} أشهر</span>
                                            </>
                                        }
                                    </div>
                                    {formation.type === "Avie" ? (
                                        <div className="flex items-center">
                                            <Navigation className="w-4 h-4 text-amber-700 ml-1" />
                                            <span className="text-gray-700">مدى الحياة. لا يوجد شهادة</span>
                                        </div>
                                    ) : formation.type === "Niveaux" ? (
                                        <div className="flex items-center">
                                            <TrendingUp className="w-4 h-4 text-amber-700 ml-1" />
                                            <span className="text-gray-700">شهادة في كل مستوى</span>
                                        </div>
                                    ) : (
                                        <div className="flex items-center">
                                            <Flag className="w-4 h-4 text-amber-700 ml-1" />
                                            <span className="text-gray-700">شهادة في النهاية</span>
                                        </div>
                                    )}
                                    <div className="flex items-center bg-amber-50 px-2 py-1 rounded-md">
                                        <Users className="w-4 h-4 text-amber-700 ml-1" />
                                        <span className="text-sm">{formation.etudiants} طالب</span>
                                    </div>
                                </div>
                                ...
                                <button
                                    className="w-full py-3 bg-gradient-to-l from-amber-600 to-amber-800 text-white rounded-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5 flex items-center justify-center cursor-pointer"
            ...
            {activeTab2 === 'mesCours' && (
                <div className="flex flex-col gap-8 bg-amber-50/40 px-6 py-8 rounded-2xl">
                    ...
                    <div className="relative flex items-center justify-center mb-2">
                        ...
                        <h2 className="text-2xl font-bold text-amber-900 px-6">تكويناتي</h2>
                        ...
                        {filteredFormations.filter(f => f.inscrit).map((formation, index) => (
                            <div key={index} className="bg-white rounded-2xl shadow-md overflow-hidden border border-amber-100 hover:shadow-xl transition-shadow duration-300">
                                <div className="relative h-48 overflow-hidden">
                                    ...
                                    />
                                    <div className="absolute top-0 left-0 bg-emerald-500 text-white px-3 py-1 m-3 rounded-full text-xs font-medium flex items-center">
                                        <Check className="w-3 h-3 ml-1" />
                                        مسجل
                                    </div>
                                    {/* Islamic decorative element */}
                                    <div className="absolute bottom-0 right-0 w-full h-6 bg-gradient-to-t from-amber-900/30 to-transparent"></div>
                                </div>
                                <div className="p-5">
                                        ...
                                        <div className="flex items-center">
                                            {formation.duree && (
                                                <>
                                                    ...
                                                    <span className="text-sm text-gray-700">{formation.duree} أشهر</span>
                                                </>
                                            )}
                                        </div>
                                        <div className="flex items-center">
                                            <Users className="w-4 h-4 text-amber-600 ml-2" />
                                            <span className="text-sm text-gray-700">{formation.etudiants} طالب</span>
                                        </div>
                                    </div>
                                    ...
                                    <button
                                        className="w-full py-3 bg-gradient-to-l from-amber-600 to-amber-800 text-white rounded-xl hover:from-amber-700 hover:to-amber-900 transition-all flex items-center justify-center cursor-pointer font-medium"
                                        onClick={() => { setActiveTab('etudier'); sessionStorage.setItem('etudier', formation.id) }}
                                    >
                                        <span>متابعة</span>
                                        <ArrowRight className="w-4 h-4 ml-2 transform rotate-180" />
                                    </button>
                                </div>
                            </div>
                        ))}
                    ...
                    {filteredFormations.filter(f => f.inscrit).length === 0 && (
                        <div className="col-span-3 bg-white p-10 rounded-2xl shadow-md border border-amber-100 text-center relative overflow-hidden">
                            ...
                            <h3 className="text-xl font-bold mb-3 text-amber-900">لم يتم العثور على أي تكوين</h3>
                            <p className="text-gray-600 mb-6">أنت لست مسجلاً في أي تكوين يتوافق مع معاييرك.</p>
                            <button
                    ...
                    <div className="col-span-1 md:col-span-2 bg-white p-6 rounded-2xl shadow-md border border-amber-100 relative">
                        ...
                        <h3 className="text-xl font-bold mb-8 text-amber-900 text-center">التكوينات الموصى بها لك</h3>
                            ...
                            {filteredFormations.filter(f => !f.inscrit).slice(0, 3).map((formation, index) => (
                                ...
                                >
                                    <div className="relative h-36 overflow-hidden">
                                        ...
                                        />
                                        {formation.prix === 0 ? (
                                            <div className="absolute bottom-0 right-0 bg-emerald-500 text-white px-3 py-1 m-2 rounded-full text-xs font-medium">
                                                مجاني
                                            </div>
                                        ) : (
                                            <div className="absolute bottom-0 right-0 bg-gradient-to-l from-amber-600 to-amber-800 text-white px-3 py-1 m-2 rounded-full text-xs font-medium">
                                                {formation.prix} درهم
                                            </div>
                                        )}
                                    </div>
                                    <div className="p-4">
                                        ...
                                        <div className="flex items-center mb-3">
                                            <User className="w-3 h-3 text-amber-700 ml-1" />
                                        ...
                                        <div className="flex space-x-1 mb-4 text-xs bg-white p-2 rounded-lg">
                                            {formation.type === "Avie" ? (
                                                <div className="flex items-center">
                                                    <Navigation className="w-3 h-3 text-amber-700 ml-1" />
                                                    <span className="text-gray-700">مدى الحياة</span>
                                                </div>
                                            ) : formation.type === "niveaux" ? (
                                                <div className="flex items-center">
                                                    <TrendingUp className="w-3 h-3 text-amber-700 ml-1" />
                                                    <span className="text-gray-700">شهادة في كل مستوى</span>
                                                </div>
                                            ) : (
                                                <div className="flex items-center">
                                                    <Flag className="w-3 h-3 text-amber-700 ml-1" />
                                                    <span className="text-gray-700">شهادة في النهاية</span>
                                                </div>
                                            )}
                                        </div>
                                        <button className="w-full py-2 bg-gradient-to-l from-amber-600 to-amber-800 text-white rounded-lg hover:from-amber-700 hover:to-amber-900 transition-all flex items-center justify-center text-sm font-medium">
                                            <span>تفاصيل</span>
                                            <ArrowRight className="w-3 h-3 ml-1 transform rotate-180" />
                                        </button>
                                    </div>
                                </div>
                            ))}
            ...
            {filteredFormations.length === 0 && activeTab2 !== 'statistiques' && (
                <div className="bg-white p-10 rounded-2xl shadow-md border border-amber-100 text-center relative overflow-hidden">
                    ...
                    <h3 className="text-xl font-bold mb-3 text-amber-900">لم يتم العثور على أي تكوين</h3>
                    <p className="text-gray-600 mb-6">لا يوجد أي تكوين يتوافق مع معايير البحث الخاصة بك.</p>
                    <button
                        className="px-6 py-3 bg-gradient-to-l from-amber-600 to-amber-800 text-white rounded-xl hover:from-amber-700 hover:to-amber-900 transition-all cursor-pointer font-medium"
                        onClick={() => {
                            setSearchQuery('')
                        ...
                        <div key={index} className="bg-white rounded-2xl shadow-md overflow-hidden border border-amber-100 hover:shadow-lg transition-shadow duration-300">
                            <div className="flex flex-col md:flex-row">
                                <div className="relative md:w-64 h-48 md:h-auto overflow-hidden">
                                    ...
                                    {formation.prix === 0 ? (
                                        <div className="absolute bottom-0 right-0 bg-emerald-500 text-white px-3 py-1 m-3 rounded-full text-xs font-medium">
                                            مجاني
                                        </div>
                                    ) : (
                                        <div className="absolute bottom-0 right-0 bg-gradient-to-l from-amber-600 to-amber-800 text-white px-3 py-1 m-3 rounded-full text-xs font-medium">
                                            {formation.prix} درهم
                                        </div>
                                    )}
                                    {/* Islamic decorative element */}
                                ...
                                <div className="p-6 flex-1 flex flex-col">
                                    <div className="flex justify-between items-start mb-3">
                                        ...
                                        <div className="flex space-x-1 bg-amber-50 p-2 rounded-lg">
                                            {formation.type === "Avie" ? (
                                                <div className="flex items-center">
                                                    <Navigation className="w-4 h-4 text-amber-700 ml-1" />
                                                    <span className="text-gray-700 text-sm">مدى الحياة</span>
                                                </div>
                                            ) : formation.type === "niveaux" ? (
                                                <div className="flex items-center">
                                                    <TrendingUp className="w-4 h-4 text-amber-700 ml-1" />
                                                    <span className="text-gray-700 text-sm">شهادة في كل مستوى</span>
                                                </div>
                                            ) : (
                                                <div className="flex items-center">
                                                    <Flag className="w-4 h-4 text-amber-700 ml-1" />
                                                    <span className="text-gray-700 text-sm">شهادة في النهاية</span>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-wrap gap-4 mb-4">
                                        ...
                                        <div className="flex items-center">
                                            <Tag className="w-4 h-4 text-amber-600 ml-2" />
