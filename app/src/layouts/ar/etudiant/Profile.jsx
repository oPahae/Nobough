...
export default function Profile({ session, setNotification }) {
    ...
    if (confirm("هل أنت متأكد من رغبتك في حذف حسابك بشكل دائم؟ هذه العملية غير قابلة للإلغاء.")) {
      try {
        ...
        if (response.ok) {
          ...
          window.location.href = '/ar/Etudiant';
        } else {
          const errorData = await response.json();
          setNotification((notif) => ({
            ...notif,
        ...
        setNotification((notif) => ({
          ...notif,
          msg: 'خطأ أثناء حذف الحساب:' + error,
          type: 'error',
          shown: true
        }))
      }
  ...
  return (
    <div className="max-w-6xl mx-auto md:p-6 relative" dir="rtl">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-amber-100 overflow-hidden relative">
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium mb-2 text-gray-700">رقم بطاقة الهوية</label>
                  <div className="relative">
        ...
        <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center p-4 bg-amber-50 rounded-lg border border-amber-200">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">يمكنك تغيير كلمة المرور لأغراض أمنية.</p>
                    </div>
                  </div>
                </div>
              ) : (
          ...
          <div className="bg-red-50 rounded-2xl shadow-lg border border-red-200 p-6 relative">
            ...
            <p className="text-sm text-red-600 mb-4">
              حذف حسابك غير قابل للإلغاء. سيتم فقدان جميع بياناتك بشكل دائم.
            </p>
