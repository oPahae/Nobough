        ...
        const fetchFormation = async () => {
            ...
            try {
                ...
                setFormData({
                    ...
                    duree: data.duree || 0,
                    categorie: data.categorie || categoriesAr[0],
                    type: data.type || "Avie",
                    genre: data.genre || "tous",
                    salle: data.salle || sallesAr[0],
                ...
                console.error('خطأ أثناء استرجاع التكوين:', error)
                setLoading(false)
            }
        }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const data = await response.json()
                console.error('خطأ أثناء تعديل التكوين:', data.message)
            }
        } catch (error) {
        ...
        <div className="max-w-4xl mx-auto relative pb-16 pt-8" dir="rtl">
            ...
            <div className="mb-8 text-center relative">
                <div className="inline-block">
                    ...
                    <h1 className="text-3xl font-bold text-gray-800">تعديل تكوين</h1>
                ...
                <p className="text-gray-600 mt-4 max-w-xl mx-auto">عدّل معلومات هذا التكوين</p>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="mb-8">
                        ...
                        <div className="grid grid-cols-1 gap-6">
                            {/* Titre */}
                            <div>
                                <label className="block text-sm font-medium mb-2 text-gray-700">عنوان التكوين</label>
                                <input
                                    type="text"
                                    name="titre"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows="4"
                                    className="w-full px-4 py-3 border border-amber-200 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                                    placeholder="صف محتوى وأهداف هذا التكوين..."
                                    required
                                ></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="flex flex-col sm:flex-row items-center gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-xs text-gray-500 mt-2">الحجم الموصى به: 800x600px، JPG أو PNG</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="mb-8">
                        <div className="flex items-center mb-4">
                            ...
                            <h3 className="text-lg font-semibold text-amber-900">تفاصيل التكوين</h3>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500 mt-1">اتركه 0 للتكوينات المجانية</p>
                            </div>
                            ...
                            {formData.type !== "Avie" &&
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 mt-1">اتركه فارغًا للتكوينات ذات المدة غير المحددة</p>
                                </div>
                            }
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <select
                                        ...
                                        required
                                    >
                                        <option value="Avie">للمدى</option>
                                        <option value="Niveaux">شهادات للمستويات</option>
                    ...
                    <div className="flex justify-between pt-6 border-t border-amber-200">
                        ...
                        >
                            <span className="font-medium">تعديل التكوين</span>
                        </button>
                    </div>
                </form>
            </div>
