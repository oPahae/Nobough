import {
    Users, Clock, Navigation, Flag, TrendingUp, Download,
        ...
        <div className="max-w-full relative" dir="rtl">
            ...
            <div className="flex justify-center mb-8 gap-6">
                <button
                    ...
                    className="px-6 py-3 bg-gradient-to-l from-amber-600 to-amber-800 text-white rounded-lg shadow-md hover:shadow-lg transition-all transform flex items-center"
                >
                    ...
                    <div key={index} className="bg-white rounded-xl shadow-xl overflow-hidden transform transition-all hover:shadow-2xl group relative">
                        <div className="relative h-48 overflow-hidden">
                            ...
                            <div className="absolute bottom-0 right-0 p-4 w-full">
                                <div className="flex justify-between items-center">
                                    {formation.prix === 0 ? (
                                        <div className="bg-gradient-to-l from-green-500 to-green-600 text-white px-3 py-1 rounded-full font-medium shadow-md">
                                            مجاني
                                        </div>
                                    ) : (
                                    ...
                                    <div className="flex space-x-1 bg-white/20 backdrop-blur-sm text-white text-xs px-2 py-1 rounded-full">
                                        ...
                                        <span className="text-xs">{formation.type === "Avie" ? "لحياة" : formation.type === "Niveaux" ? "مستويات" : "شهادة"}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="p-6 relative">
                            ...
                            <div className="flex items-center mb-4">
                                <div className="w-8 h-8 rounded-full bg-amber-100 flex items-center justify-center ml-2">
                            ...
                            <div className="flex justify-between items-center mb-4">
                                ...
                                {formation.type === "Avie" ? (
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-gray-700">لحياة، لا شهادة</span>
                                    </div>
                                ) : formation.type === "Niveaux" ? (
                                    <div className="flex items-center">
                                ...
                                <div className="flex items-center bg-amber-50 px-2 py-1 rounded-md">
                                    ...
                                    <span className="text-sm">{formation.etudiants} طلاب</span>
                                </div>
                            </div>
