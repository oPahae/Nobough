        ...
        if (validateForm()) {
            try {
                ...
                if (response.ok) {
                    ...
                    setErrors({ submit: data.message || 'خطأ أثناء إضافة المصروف' })
                }
            } catch (error) {
                console.error('خطأ أثناء إضافة المصروف:', error)
                setErrors({ submit: 'حدث خطأ ما. الرجاء المحاولة مرة أخرى لاحقًا.' })
            }
        }
    }
    ...
    return (
        <div className="pt-4 pb-16" dir="rtl">
            <div className="flex items-center mb-6">
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-amber-800">إضافة مصروف</h2>
            </div>
            ...
            {showSuccess && (
                <div className="mb-6 p-4 bg-green-50 border-r-4 border-green-500 rounded-md flex items-center">
                    ...
                    <span className="text-green-700">تمت إضافة المصروف بنجاح!</span>
                </div>
            )}
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden border border-amber-100">
                <div className="p-4 border-b border-amber-100 bg-gradient-to-l from-amber-50 to-white">
                    <h3 className="text-md font-medium text-amber-800">معلومات المصروف</h3>
                    <p className="text-sm text-amber-600 mt-1">الرجاء ملء جميع الحقول الإجبارية (*)</p>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div className="relative">
                                ...
                                >
                                    <option value="Salaires des professeurs">رواتب الأساتذة</option>
                                    <option value="Fournitures">مستلزمات</option>
