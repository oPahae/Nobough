...
export default function ProfileProfesseur({ session, setNotification }) {
    ...
    if (confirm("Êtes-vous sûr de vouloir supprimer définitivement votre compte ? Cette action est irréversible.")) {
      try {
        ...
        if (response.ok) {
          ...
          window.location.href = '/fr/Professeur';
        } else {
          const errorData = await response.json();
          setNotification((notif) => ({
            ...notif,
  ...
  return (
    <div className="w-full mx-auto md:p-6 relative">
            ...
            <div className="p-8">
                ...
                {!editingPersonal ? (
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button
                      onClick={() => {
                        setEditingPersonal(false);
                        fetchInfos(); // Recharger les données
                      }}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <BookOpen className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-amber-700" />
                    <input
                      type="text"
