    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const data = await response.json();
                console.error('Erreur lors de l\'ajout de la formation:', data.message);
            }
        } catch (error) {
        ...
        <div className="max-w-4xl mx-auto relative pb-16 pt-8">
            ...
            <div className="mb-8 text-center relative">
                <div className="inline-block">
                    ...
                    <h1 className="text-3xl font-bold text-gray-800">Ajouter une formation</h1>
                ...
                <p className="text-gray-600 mt-4 max-w-xl mx-auto">Créez une nouvelle formation pour enrichir notre catalogue</p>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-amber-100 p-8 relative">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-between pt-6 border-t border-amber-200">
                        ...
                        >
                            <span className="font-medium">Ajouter la formation</span>
                        </button>
                    </div>
                </form>
            </div>
