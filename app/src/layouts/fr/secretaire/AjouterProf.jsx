...
export default function AjouterProf({ setActiveTab }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const data = await response.json()
                setErrors({ general: data.message || 'Erreur lors de l\'ajout du professeur' })
            }
        } catch (error) {
    ...
    return (
        <>
            <Head>
                <title>Ajouter un professeur - Académie Nobough</title>
            ...
            <div className="max-w-full relative">
                ...
                <div className="mb-12 text-center pt-8 relative">
                    ...
                    <p className="text-gray-600 mt-4 max-w-xl mx-auto">Ajoutez un nouveau professeur à l'équipe pédagogique</p>
                </div>
                    ...
                    {submitted ? (
                        <div className="bg-white/90 backdrop-blur-sm p-8 rounded-xl shadow-xl mb-10 border border-amber-100">
                            <div className="flex flex-col items-center text-center">
                                ...
                                <h2 className="text-2xl font-bold text-gray-800 mb-4">Professeur ajouté avec succès !</h2>
                                <p className="text-gray-600 mb-8">Le professeur a été ajouté à la base de données.</p>
                                <button
