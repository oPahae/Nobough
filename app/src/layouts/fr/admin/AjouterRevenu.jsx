        ...
        if (validateForm()) {
            try {
                ...
                if (response.ok) {
                    ...
                    setErrors({ submit: data.message || 'Erreur lors de l\'ajout du revenu' })
                }
            } catch (error) {
    ...
    return (
        <div className="pt-4 pb-16">
            <div className="flex items-center mb-6">
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-amber-800">Ajouter un revenu</h2>
            </div>

            {showSuccess && (
                <div className="mb-6 p-4 bg-green-50 border-l-4 border-green-500 rounded-md flex items-center">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                    <span className="text-green-700">Le revenu a été ajouté avec succès!</span>
                </div>
            )}
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden border border-amber-100">
                <div className="p-4 border-b border-amber-100 bg-gradient-to-r from-amber-50 to-white">
                    <h3 className="text-md font-medium text-amber-800">Informations du revenu</h3>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <option value="Paiements mensuels">Paiements mensuels</option>
