...
export default function Login({ session, setNotification }) {
    ...
    return (
        <>
            ...
            <div className="max-w-full md:px-96 relative pb-12 bg-white/60 backdrop-blur-3xl">
                {/* Decore */}
                    ...
                    {submitted ? (
                        <div className="bg-white/90 backdrop-blur-sm p-8 rounded-xl shadow-xl mb-10 border border-amber-100">
                            <div className="flex flex-col items-center text-center">
                                ...
                                <p className="text-gray-600 mb-8">Bienvenue. Vous êtes maintenant connecté.</p>
                                <button
