...
export default async function handler(req, res) {
    if (req.method === 'POST') {
        ...
        try {
            ...
            const msg = `Votre inscription a été validée`
            ...
            await transporter.sendMail({
                ...
                html: `
                    <div style="font-family: Arial, sans-serif; color: #333; background-color: #f9f9f9; padding: 20px; border-radius: 8px; max-width: 600px; margin: auto; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                        ...
                        <p style="font-size: 16px; line-height: 1.5; text-align: center;">
                            On vous remercie pour votre inscription à notre formation, voici votre lien de paiement du premier mois :
                        ...
                        <p style="font-size: 14px; line-height: 1.5; text-align: center; color: #777;">
                            Ce lien vous permet de prouver votre paiement, quand le paiement sera validé vous serez capables d'accéder à l'espace de la formation.
                        </p>
