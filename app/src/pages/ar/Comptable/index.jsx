...
import Header from '../../../components/ar/comptable/Header'
import Alertes from '../../../components/ar/comptable/Alertes'

import Budget from '../../../layouts/ar/comptable/Budget'
import Revenus from '../../../layouts/ar/comptable/Revenus'
import Depenses from '../../../layouts/ar/comptable/Depenses'
import Dettes from '../../../layouts/ar/comptable/Dettes'
import Evenements from '../../../layouts/ar/comptable/Evenements'
import Salaires from '../../../layouts/ar/comptable/Salaires'

import AjouterRevenu from '../../../layouts/ar/comptable/AjouterRevenu'
import ModifierRevenu from '../../../layouts/ar/comptable/ModifierRevenu'
import AjouterDepense from '../../../layouts/ar/comptable/AjouterDepense'
import ModifierDepense from '../../../layouts/ar/comptable/ModifierDepense'
import AjouterDette from '../../../layouts/ar/comptable/AjouterDette'
import ModifierDette from '../../../layouts/ar/comptable/ModifierDette'
import AjouterEvenement from '../../../layouts/ar/comptable/AjouterEvenement'
import ModifierEvenement from '../../../layouts/ar/comptable/ModifierEvenement'
...
export default function Comptable({ session, setNotification }) {
  ...
  return (
    <div dir="rtl">
      <Head>
        <title>لوحة التحكم المحاسبية - أكاديمية نبوغ</title>
            ...
            <div className="backdrop-blur-3xl p-6 rounded-3xl max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div className="text-white font-bold">
                ...
                <p className="flex items-center gap-2">
                  ...
                  من السبت إلى الخميس، 9 صباحًا - 11 مساءً
                </p>
              </div>
            </div>
