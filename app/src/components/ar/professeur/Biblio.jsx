import {
    ...
    MapPin, Sparkles, Moon, Image, DoorClosed
} from 'lucide-react'
...
const Biblio = ({ formationID, session }) => {
    ...
    const PatternDecoration = () => (
        <div className="absolute left-0 top-0 w-24 h-24 opacity-10 -rotate-45 z-0">
    ...
    const handleAddDoc = async (e) => {
        ...
        if (!newDoc.titre || !newDoc.file) {
            setNotification((notif) => ({
                ...notif,
                msg: 'الرجاء ملء جميع الحقول الإلزامية',
                type: 'info',
                shown: true
            }))
            return
        ...
        <div className="max-w-full relative" dir="rtl">
            ...
            <div className="mb-8 flex justify-start">
                <button
                    ...
                    className="px-4 py-2 bg-gradient-to-l from-amber-600 to-amber-800 text-white rounded-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5 cursor-pointer flex items-center"
                >
                    <PlusCircle className="w-4 h-4 ml-2" />
                    <span className="font-medium">إضافة مستند</span>
                </button>
            </div>
                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-md z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl">
                        <div className="p-6 border-b border-amber-100">
                            <h2 className="text-xl font-bold text-amber-800">إضافة مستند</h2>
                            <p className="text-sm text-gray-600 mt-1">املأ معلومات المستند الذي تريد إضافته</p>
                        </div>
                        ...
                        <form onSubmit={handleAddDoc} className="p-6">
                                        ...
                                        {newDoc.file && (
                                            <div className="mt-2 p-3 bg-amber-50 rounded-lg">
                                                <p className="text-sm text-gray-700">
                                                    الملف المختار: {newDoc.file.name} ({Math.round(newDoc.file.size / 1024)} ك.ب)
                                                </p>
                                            </div>
                                        )}
                                    </div>
                            ...
                            <div className="mt-8 flex justify-start space-x-3">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 bg-gradient-to-l from-amber-600 to-amber-800 text-white rounded-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5 cursor-pointer flex items-center disabled:opacity-50"
                                >
                                    {isUploading ? (
                                        <>
            ...
            <div className="mb-12 text-center pt-8 relative">
                ...
                <p className="text-gray-600 mt-4 max-w-xl mx-auto">الوصول إلى مجموعة من الموارد التعليمية عالية الجودة لإثراء مسارك التعليمي</p>
            </div>
            ...
            <div className="mb-8 relative max-w-2xl mx-auto">
                ...
                <input
                    ...
                    placeholder="بحث عن مستند حسب العنوان، الوصف..."
                    value={searchQuery}
            ...
            <div className="space-y-6 max-w-5xl mx-auto">
                {filteredDocuments.length > 0 ? (
                            ...
                            <div className="p-6 relative">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4">
                                                ...
                                                <span className="text-sm text-gray-700">
                                                    {document.taille < 1024
                                                        ...
                                                        : document.taille < 1024 * 1024
                                                            ? `${(document.taille / 1024).toFixed(2)} ك.ب`
                                                            : `${(document.taille / (1024 * 1024)).toFixed(2)} م.ب`
                                                    }
                                                </span>
                                            </div>
                                            <div className="flex items-center bg-amber-50 px-2 py-1 rounded-md">
                                                <Tag className="w-4 h-4 text-amber-700 ml-1" />
                                    ...
                                    <div className="flex items-center justify-start space-x-2">
                                        <button
                                            className="py-3 px-5 z-10 bg-gradient-to-l from-amber-600 to-amber-800 text-white rounded-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5 cursor-pointer flex items-center"
                    ...
                    <div className="bg-white p-10 rounded-2xl shadow-md border border-amber-100 text-center relative overflow-hidden">
                        ...
                        <h3 className="text-xl font-bold mb-3 text-amber-900">لم يتم العثور على أي مستند</h3>
                        <p className="text-gray-600 mb-6">لا يوجد مستندات تطابق معايير البحث الخاصة بك.</p>
                        <button
