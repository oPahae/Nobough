import {
    ...
    PlusCircle, Send, Paperclip, Image, FileIcon, Delete,
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div className="relative">
                                ...
                                >
                                    <option value="tous">جميع الأعمار</option>
                        ...
                        <div key={etudiant.id} className="bg-white rounded-xl shadow-xl overflow-hidden transform transition-all hover:-translate-y-1 hover:shadow-2xl group relative">
                            <div className="p-6 relative">
                                ...
                                <div className="flex flex-col items-center mb-4">
                                    ...
                                    <p className="text-gray-500 text-sm">مسجل منذ {new Date(etudiant.dateInscr).toLocaleDateString('FR-fr')}</p>
                                </div>
                                ...
                                <div className="mb-5 border-t border-amber-100 pt-4">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-center bg-amber-50 p-2 rounded-lg">
                                            ...
                                            <span className="text-gray-700 text-sm">ولد في {new Date(etudiant.birth).toLocaleDateString('FR-fr')}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="mt-6 flex justify-start">
                                    <button onClick={() => generateCertificat(etudiant.id)} className="px-6 py-3 bg-gradient-to-l from-amber-600 to-amber-800 text-white rounded-lg shadow-md hover:shadow-lg transition-all flex items-center justify-center cursor-pointer">
                                        <span className="font-medium">إنشاء شهادة</span>
                        ...
                        <div key={etudiant.id} className="bg-white rounded-xl shadow-md overflow-hidden border border-amber-100 hover:shadow-lg transition-shadow duration-300">
                            <div className="flex flex-col md:flex-row">
                                <div className="p-6 md:w-64 flex flex-col items-center justify-center border-l border-amber-100">
                                    ...
                                    <p className="text-gray-500 text-sm text-center">مسجل منذ {new Date(etudiant.dateInscr).toLocaleDateString('FR-fr')}</p>
                                </div>
                    ...
                    <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl">
                        <div className="p-6 border-b border-amber-100">
                            <div className="flex justify-between items-center">
                                <h2 className="text-xl font-bold text-amber-800">إنشاء شهادة</h2>
                                <button
                            ...
                            <p className="text-sm text-gray-600 mt-1">املأ معلومات الشهادة</p>
                        </div>
