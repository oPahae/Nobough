                ...
                <div className="bg-white shadow-xl md:hidden z-50 rounded-b-lg overflow-hidden border-t border-amber-100">
                    <ul className="flex flex-col">
                        {currentFormationID && (
                            <li>
                                <button
                                    className={`px-4 py-3 font-medium transition-all w-full text-right flex items-center justify-between ${activeTab === 'formation' ? 'bg-amber-50 text-amber-800' : 'hover:bg-amber-50'}`}
                                    onClick={() => handleTabChange('formation')}
                                >
                                    <div className="flex items-center">
                                        <PieChart className={`w-5 h-5 ml-3 ${activeTab === 'formation' ? 'text-amber-600' : 'text-gray-500'}`} />
                                        <span>الأحدث</span>
                                    </div>
