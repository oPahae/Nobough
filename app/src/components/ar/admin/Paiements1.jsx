        ...
        <div dir="rtl">
            <div className="max-w-full relative">
                ...
                <div className="mb-12 text-center pt-8 relative">
                    ...
                    <p className="text-gray-600 mt-4 max-w-xl mx-auto">التحقق من المعاملات وإدارة طلبات الدفع</p>
                </div>

                <div className="max-w-6xl mx-auto pb-16">
                    <div className="bg-white rounded-xl shadow-xl overflow-hidden border border-amber-100 mb-8">
                        <div className="relative flex items-center justify-center p-6 bg-gradient-to-l from-amber-50 to-amber-100">
                            <div className="w-10 h-10 rounded-full bg-gradient-to-bl from-amber-400 to-amber-700 flex items-center justify-center shadow-md ml-4">
                                <CreditCard className="w-5 h-5 text-white" />
                            </div>
                            <h2 className="text-2xl font-bold text-amber-800">مدفوعات جديدة ({paiements.length})</h2>
                        </div>
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-between p-6 relative">
                                        <div className="flex mb-4 sm:mb-0">
                                            <img
                                                ...
                                                className="w-16 h-16 rounded-full object-cover ml-4 border-2 border-amber-200"
                                            />
                                            <div>
                                                ...
                                                <p className="text-gray-600 text-sm flex items-center">
                                                    <Calendar className="w-4 h-4 ml-1 text-amber-600" />
                                                    الدفع بتاريخ {new Date(paiement.created_At).toLocaleDateString('FR-fr')}
                                                </p>
                                                <p className="font-medium text-amber-600 flex items-center mt-1">
                                                    <DollarSign className="w-4 h-4 ml-1" />
                                                    {paiement.montant} درهم
                                                </p>
                                            </div>
                                        </div>
                                        <div className="flex items-center space-x-3">
                                            <button
                                                className="py-2 px-4 bg-gradient-to-l from-green-500 to-green-600 text-white rounded-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5 flex items-center"
                                            ...
                                            {showRefuseReasonPaiement[paiement.id] ? (
                                                <div className="flex items-center">
                                                    <input
                                                        type="text"
                                                        className="py-2 px-4 border border-amber-200 rounded-lg ml-2 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                                                    ...
                                                    />
                                                    <button
                                                        className="py-2 px-4 bg-gradient-to-l from-red-500 to-red-600 text-white rounded-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5 flex items-center"
                                                ...
                                                <button
                                                    className="py-2 px-4 bg-gradient-to-l from-gray-200 to-gray-300 text-gray-700 rounded-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5 flex items-center"
                                    ...
                                    <details className="px-6 pb-6 border-t border-amber-100">
                                        <summary className="py-3 cursor-pointer focus:outline-none text-amber-700 font-medium flex items-center">
                                            <div className="flex items-center w-full">
                                                ...
                                                <span>عرض تفاصيل الدفع</span>
                                                <ChevronRight className="w-4 h-4 mr-2 text-amber-600 transform rotate-180" />
                                                <div className="mr-auto h-px w-1/2 bg-gradient-to-l from-transparent to-amber-200"></div>
                                            </div>
                                        </summary>
                                            ...
                                            <div className="bg-amber-50/50 p-4 rounded-xl">
                                                ...
                                                <div className="space-y-3 text-sm">
                                                    <div className="flex items-center">
                                                        ...
                                                        <span className="mr-2 text-gray-600">{paiement.prenom} {paiement.nom}</span>
                                                    </div>
                                                    <div className="flex items-center">
                                                        <div className="w-6 h-6 rounded-full bg-amber-100 flex items-center justify-center ml-2">
                                                        ...
                                                        <span className="mr-2 text-gray-600">{paiement.birth}</span>
                                                    </div>
                                                    <div className="flex items-center">
                                                        <div className="w-6 h-6 rounded-full bg-amber-100 flex items-center justify-center ml-2">
                                                        ...
                                                        <span className="mr-2 text-gray-600">{paiement.cin}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="bg-amber-50/50 p-4 rounded-xl">
                                                ...
                                                <div className="space-y-3 text-sm">
                                                    <div className="flex items-center">
                                                        ...
                                                        <span className="mr-2 text-gray-600">{paiement.email}</span>
                                                    </div>
                                                    <div className="flex items-center">
                                                        <div className="w-6 h-6 rounded-full bg-amber-100 flex items-center justify-center ml-2">
                                                        ...
                                                        <span className="mr-2 text-gray-600">{paiement.tel}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="bg-amber-50/50 p-4 rounded-xl">
                                                ...
                                                <div className="space-y-3 text-sm">
                                                    <div className="flex items-center">
                                                        ...
                                                        <span className="mr-2 text-amber-600 font-medium">{paiement.montant} درهم</span>
                                                    </div>
                                                    <div className="flex items-center">
                                                        <div className="w-6 h-6 rounded-full bg-amber-100 flex items-center justify-center ml-2">
                                                            <Calendar className="w-3 h-3 text-amber-700" />
                                                        ...
                                                        <span className="mr-2 text-gray-600">{new Date(paiement.created_At).toLocaleDateString('FR-fr')}</span>
                                                    </div>
                                                    <div>
                                                        <p className="font-medium flex items-center mb-2">
                                                            <span className="w-6 h-6 rounded-full bg-amber-100 flex items-center justify-center ml-2">
                                                                <FileText className="w-3 h-3 text-amber-700" />
                                                            </span>
                                                            الرسالة:
                                                        </p>
                                                        <p className="text-gray-600 mr-8 bg-white p-3 rounded-lg border border-amber-100">{paiement.msg}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="bg-amber-50/50 p-4 rounded-xl">
