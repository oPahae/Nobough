        ...
        <div className="max-w-full relative" dir="rtl">
            <div className="absolute inset-0 overflow-hidden opacity-5 pointer-events-none">
                ...
                <div className="absolute -bottom-24 left-1/4 w-72 h-72 opacity-20">
                    <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                        <path fill="#B880B" d="M50,0 L60,40 L100,40 L70,65 L80,100 L50,80 L20,100 L30,65 L0,40 L40,40 Z"></path>
                    </svg>
                </div>
            </div>
            ...
            <div className="mb-12 text-center pt-8 relative">
                <div className="inline-block">
                    ...
                    <h1 className="text-3xl font-bold text-gray-800">برنامج التدريب</h1>
                ...
                <p className="text-gray-600 mt-4 max-w-xl mx-auto">اكتشف الجدول الزمني المفصل وثري مسارك التعليمي</p>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-sm p-8 rounded-xl shadow-xl mb-10 max-w-5xl mx-auto border border-amber-100">
                <div className="flex items-center mb-6">
                    ...
                    <h3 className="text-lg font-semibold mr-3 text-gray-800">تقويم الجلسات</h3>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {programme.map((prog, index) => (
                        <div key={index} className="bg-white rounded-xl shadow-xl overflow-hidden transform transition-all hover:-translate-y-1 hover:shadow-2xl group relative border border-amber-100">
                            <div className="relative p-1 bg-gradient-to-l from-amber-500 to-amber-700">
                                <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent"></div>
                                <h3 className="text-center font-bold py-2 text-white">الجلسة {index + 1}</h3>
                            </div>
                            <div className="p-6 relative">
                                ...
                                <div className="flex items-center my-4 bg-amber-50 p-3 rounded-lg">
                                    <Calendar className="w-5 h-5 ml-3 text-amber-700 flex-shrink-0" />
                                ...
                                <div className="flex items-center my-4 bg-amber-50 p-3 rounded-lg">
                                    <Clock className="w-5 h-5 ml-3 text-amber-700 flex-shrink-0" />
                                    <div className="flex flex-col">
                                ...
                                <div className="flex items-center my-4 bg-amber-50 p-3 rounded-lg">
                                    <MapPin className="w-5 h-5 ml-3 text-amber-700 flex-shrink-0" />
                                    <div className="flex flex-col">
