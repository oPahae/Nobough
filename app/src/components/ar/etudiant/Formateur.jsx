    ...
    useEffect(() => {
        const fetchFormateur = async () => {
            try {
                ...
                if (!response.ok) {
                    throw new Error('خطأ أثناء استرجاع بيانات المدرس')
                }
                ...
                console.error('خطأ أثناء استرجاع المدرس:', error)
        ...
        return (
            <div className="max-w-5xl mx-auto p-8 text-center">
                <div className="bg-amber-50 border-r-4 border-amber-500 p-4 rounded-md mb-4">
                    <h2 className="text-amber-700 font-medium">المدرس غير موجود</h2>
                    <p className="text-amber-600">المدرس لهذه الدورة غير متوفر.</p>
                </div>
            </div>
        )
    }
        ...
        <div className="max-w-full relative" dir="rtl">
            ...
            <div className="mb-12 text-center pt-8 relative">
                <div className="inline-block">
                    ...
                    <h1 className="text-3xl font-bold text-gray-800">ملف المدرس</h1>
                ...
                <p className="text-gray-600 mt-4 max-w-xl mx-auto">اكتشف مهارات وخبرة مدرسينا المتميزين</p>
            </div>
                    ...
                    <div className="md:w-1/3">
                        <div className="bg-amber-50/60 rounded-xl p-6 text-center relative overflow-hidden shadow-md border border-amber-100">
                            ...
                            <div className="relative mb-6">
                                ...
                                <p className="text-gray-600 mb-2">مدرس</p>
                            ...
                            <div className="space-y-4 text-right mb-6">
                                <div className="flex items-center p-3 bg-white/70 rounded-lg shadow-sm hover:shadow transition-all">
                                    <Mail className="w-5 h-5 text-amber-700 ml-3" />
                                    <span className="text-gray-700">{formateur.email}</span>
                                </div>
                                <div className="flex items-center p-3 bg-white/70 rounded-lg shadow-sm hover:shadow transition-all">
                                    <Phone className="w-5 h-5 text-amber-700 ml-3" />
                                    <span className="text-gray-700">{formateur.tel}</span>
                                </div>
                                <div className="flex items-center p-3 bg-white/70 rounded-lg shadow-sm hover:shadow transition-all">
                                    <Calendar className="w-5 h-5 text-amber-700 ml-3" />
                                    <span className="text-gray-700">ولد في {new Date(formateur.birth).toLocaleDateString('FR-fr')}</span>
                                </div>
                            </div>

                            <div className="flex justify-around mb-4 p-4 bg-gradient-to-l from-amber-50 to-amber-100 rounded-xl shadow-sm">
                                <div className="text-center">
                                    <p className="text-2xl font-bold text-amber-800">{formateur.formations}</p>
                                    <p className="text-sm text-gray-600">دورات</p>
                                </div>
                    ...
                    <div className="md:w-2/3">
                        <div className="bg-white border border-amber-100 rounded-xl shadow-md p-8 mb-6 relative overflow-hidden">
                            ...
                            <div className="flex items-center mb-6">
                                ...
                                <h2 className="text-xl font-semibold mr-3 text-gray-800">السيرة الذاتية</h2>
                            </div>

                            <div className="relative">
                                <div className="absolute top-0 right-0 w-4 h-8 border-t-2 border-r-2 border-amber-300"></div>
                                <p className="text-gray-700 mb-6 px-6 py-2">{formateur.bio}</p>
                                <div className="absolute bottom-0 left-0 w-4 h-8 border-b-2 border-l-2 border-amber-300"></div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white border border-amber-100 rounded-xl shadow-md p-8 relative overflow-hidden">
                            ...
                            <div className="flex items-center mb-6">
                                ...
                                <h3 className="text-xl font-semibold mr-3 text-gray-800">التخصصات</h3>
                            </div>
