    ...
    return (
        <div className="max-w-full relative md:px-22" dir="rtl">
            ...
            <div className="mb-12 text-center pt-8 relative">
                ...
                <p className="text-gray-600 mt-4 max-w-xl mx-auto">تبادل الرسائل مع زملائك / أستاذك ومشاركة المعلومات</p>
            </div>
            ...
            <div className="bg-transparent rounded-xl shadow-xl mb-6 overflow-hidden relative">
                ...
                <div className="flex flex-col h-screen max-h-[70vh]">
                    <div className="flex-grow overflow-y-auto p-6 bg-transparent">
                        {messages.map((msg) => (
                            <div key={msg.id} className={`mb-6 ${msg.emetteurID === session.id ? 'flex justify-start' : 'flex justify-end'}`}>
                                ...
                                <div className={`max-w-[75%] ${msg.emetteurID === session.id ? 'order-2' : 'order-1'}`}>
                                    {true && (
                                    ...
                                    <div className={`rounded-2xl p-4 shadow-md ${msg.emetteurID === session.id
                                        ...
                                        : msg.role === 'professeur'
                                            ...
                                            : 'bg-gray-100 border border-gray-200 text-gray-800 rounded-br-none'
                                        }`}>
                                        <p className="break-words leading-relaxed">{msg.contenu}</p>
                                        <div className={`text-xs mt-2 ${msg.emetteurID === session.id ? 'text-amber-200' : 'text-gray-500'} text-left`}>
