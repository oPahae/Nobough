    ...
    return (
        <div className="max-w-full relative md:px-22">
            ...
            <div className="mb-12 text-center pt-8 relative">
                ...
                <p className="text-gray-600 mt-4 max-w-xl mx-auto">Echanger les messages avec vos étudiants</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-xl mb-6 overflow-hidden relative">
                ...
                <div className="flex flex-col h-screen max-h-[70vh]">
                    <div className="flex-grow overflow-y-auto p-6 bg-white/90">
                        {messages.map((msg) => (
                            <div key={msg.id} className={`mb-6 ${msg.role === 'professeur' ? 'flex justify-end' : 'flex justify-start'}`}>
                                {msg.role !== 'professeur' && (
                                    <div className="mr-3">
                                ...
                                <div className={`max-w-[75%] ${msg.role === 'professeur' ? 'order-1' : 'order-2'}`}>
                                    {true && (
                                    ...
                                    <div className={`rounded-2xl p-4 shadow-md ${msg.role === 'professeur'
                                        ...
                                        <div className={`text-xs mt-2 ${msg.role === 'professeur' ? 'text-amber-200' : 'text-gray-500'} text-right`}>
