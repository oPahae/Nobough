...
const Header = ({ activeTab, setActiveTab, headerOpened, setHeaderOpened, etudiantID, setEtudiantID, protestations }) => {
    ...
    const notifications = [
        { type: 'adhesion', message: 'Nouvelle demande d\'adhésion', date: '24/04/2025' },
        { type: 'inscription', message: 'Nouvelle inscription à traiter', date: '01/04/2025' },
        { type: 'protestation', message: 'Nouvelle protestation reçue', date: '20/04/2025' },
        { type: 'paiement', message: 'Paiement en attente de validation', date: '15/04/2025' },
    ]
                ...
                <div className="container mx-auto flex justify-between items-center py-2 flex-col sm:flex-row" onClick={() => { setShowNotifications(false); setShowProfileMenu(false); setMobileMenuOpen(false) }}>
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="relative pl-4">
                            ...
                            <p className="text-xs sm:text-sm text-amber-700">Espace Secrétaire</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-4 mt-3 sm:mt-0">
                        {/* Liens supplémentaires - Desktop */}
                        <div className="hidden md:flex gap-3">
                            <Link href="/ar/Secretaire">
                            ...
                            <li>
                                ...
                                >
                                    <div className="flex items-center">
                                        <Clock className={`w-5 h-5 mr-3 ${activeTab === 'etudiant' ? 'text-amber-600' : 'text-gray-500'}`} />
                                        <span>Récent</span>
                                    </div>
