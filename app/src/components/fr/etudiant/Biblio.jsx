                            ...
                            <div className="p-6 relative">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4">
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <div className="flex flex-wrap gap-4 mb-4">
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <span className="text-sm text-gray-700">{document.taille} mo</span>
                                            </div>
                                    ...
                                    <div className="flex items-center justify-end">
                                        <button
                                            className="py-3 px-5 bg-gradient-to-r from-amber-600 to-amber-800 text-white rounded-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5 cursor-pointer flex items-center"
